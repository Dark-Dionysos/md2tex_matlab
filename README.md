...
3. Lanch the [Matlab](https://www.mathworks.com/products/matlab.html), in the command window, type following commands:`cd ~/md2tex`, `md2tex_matlab('<your md file name>'`, for using arguments, please refer [Heading and Author](#heading).
